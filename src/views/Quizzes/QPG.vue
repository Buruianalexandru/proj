...
export default {
  ...
  methods: {
    ...
    submitAnswer(questionId, answer) {
      this.submitQuizAnswer({ questionId, answer, lessonId: 'xlP1bPzgOCpxLRleyzN3' }); 
    ...
    calculateResult() {
      ...
      const lessonID = 'xlP1bPzgOCpxLRleyzN3';
      ...
      this.$router.push({ name: 'qrep',query:{ score: this.score, lessonID:'qpg' , courseID:'progresii',name:'qpg'} });
    },
    retryQuiz() {
  ...
  created() {
    this.fetchQuizzesByLessons('qpg'); // ID-ul lecției curente
  }
}
</script>
